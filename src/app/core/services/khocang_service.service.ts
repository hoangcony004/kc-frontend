...
export interface IKho_Cang_Service {
     ...
     * @return OK
     */
    apiPrivateUsersSearchPaging(body: PageModel): Observable<ApiResponseListSysUser>;
    /**
     * @return OK
     */
...
export class Kho_Cang_Service implements IKho_Cang_Service {
    ...
    constructor(@Inject(HttpClient) http: HttpClient, @Optional() @Inject(API_BASE_URL) baseUrl?: string) {
        this.http = http;
        this.baseUrl = baseUrl !== undefined && baseUrl !== null ? baseUrl : "http://localhost:6868";
    }
    ...
    protected processApiPrivateUsersSearchPaging(response: HttpResponseBase): Observable<ApiResponseListSysUser> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
